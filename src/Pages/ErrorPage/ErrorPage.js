  ...
  return (
    <div>
      <div class="bg-white py-6 sm:py-8 lg:py-12">
        <div class="max-w-screen-2xl px-4 md:px-8 mx-auto h-screen grid place-items-center">
          <div class="w-full sm:w-96  bg-gray-600 shadow-lg rounded-lg overflow-hidden relative mx-auto">
            {/* <img
